...
Método: Define
**************
En este método sequelize se definen todos los atributos correspondientes a la tabla **skills**
...
.. literalinclude:: ../../Backend/models/skill.model.js
   :language: javascript
   :linenos:
   :lines: 11-29
...
``Skill_Id`` ambos definidos en el Modelo PerfilHabilidades.
